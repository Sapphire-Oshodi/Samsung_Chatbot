...
st.markdown("<h6 style = 'text-align: center; top-margin: 0rem; color: #64CCC5'>BUILT BY SAPPHIRE</h1>", unsafe_allow_html = True)

st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('pngwing.com (1).png', caption = 'Samsung Products Related Chats')
...
user_q = col2.text_input('Please make your enquiries about Samsung Products: ')
